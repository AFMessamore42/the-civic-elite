...
In order to construct board networks from 2010 on, we need data from Amazon Web Services that contains the board information from Forms 990/Forms 990EZ filers across the United States from 2010 to 2017. We will then need to match this board data to a set of all active nonprofits in Texas between 2013 and 2016 to a subset of organizations. 
...
1. The Revenues and Expenses from the Business Master File (for organizational data)
2. The Officers file, which contains information on board members. 
...
load('/Users/Wolfalev/Documents/Grad/UT-AUSTIN GRAD/Articles and Projects/4. Nonprofit Interlock/GitHub/DATA/BMF_RevExp_Loaded.RData')
load('/Users/Wolfalev/Documents/Grad/UT-AUSTIN GRAD/Articles and Projects/4. Nonprofit Interlock/GitHub/DATA/Officers_Loaded.RData')
