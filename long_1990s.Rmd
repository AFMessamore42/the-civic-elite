...
texas_filers <- read.csv("filers_boards_1990s.csv")
```
...
```{r, eval=FALSE}
save.image("~/Users/Wolfalev/Documents/Grad/UT-AUSTIN GRAD/Articles and Projects/4. Nonprofit Interlock/GitHub/DATA/Austin_1990s.RData)
```
